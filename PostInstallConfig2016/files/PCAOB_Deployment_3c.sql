...
--10132016 extended variable character length for user name
...
create proc [dbo].[Audit_ServerRoles_2a]
  as
Declare @name varchar(100),@srvname varchar(100),@ServerRole2 varchar(55),@dbrole2 varchar(55),@membername varchar(100),@timestamp varchar(25)
Set NOCOUNT ON
...
Print @srvname +  ','+ @dbrole2 + ','+ @ServerRole2 + ',' + @timestamp + ',' + 'SrvRole'
...
as
Declare @name varchar(100),@srvname varchar(55),@dbname2 varchar(100),@dbrole2 varchar(55),@membername varchar(100),@timestamp varchar(25)
Set NOCOUNT ON
Select @timestamp = CONVERT(varchar, CURRENT_TIMESTAMP , 112)
...
Print @srvname +  ','+@dbname2 + ',' + @membername + ','+   @dbrole2 + ',' + @timestamp + ',' + 'DBRole'
...
RECONFIGURE WITH OVERRIDE
GO
Declare @sqlsvr varchar(100),@sqlstr2 varchar(500),@timestamp varchar(25)
select @timestamp = CONVERT(varchar, CURRENT_TIMESTAMP , 112)
